...
class CUIHanderlFace : public IOleClientSite, public IDocHostUIHandler
{
public:
    CUIHanderlFace();
    virtual ~CUIHanderlFace();
...
private:
    ...
    CComQIPtr <IOleClientSite>		m_defaultClientSite;
    CComQIPtr <IDocHostUIHandler>	m_defaultDocHostUIHandler;
};
